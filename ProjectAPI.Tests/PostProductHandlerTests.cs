...
namespace ProjectAPI.Tests
{
    public class PostProductHandlerTests : IDisposable
    {
        ...
        public PostProductHandlerTests()
        {
            ...
            //handler = new PostProductHandler(mockContext, mockMapper, mockLogger, mockValidator); TODO uncomment
        }
        ...
        {
            //Arange
            request = new PostProductRequest
            {
        ...
        [InlineData("123", "1", 5)]
        public async Task PostProductHandler_ThrowsAgrumentException_IfInvalidModelPassed(string name,
